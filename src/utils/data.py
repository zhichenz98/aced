...
def load_case30(root='../data/case30_opf/data', topo=0, sigma='0.01', bias='0.00'):
    ...
    branches = pd.read_csv(os.path.join(root, 'case30_topo0_branches.csv'), header=None).values  # starts with 1
    ...
    results = pd.read_csv(os.path.join(root, f'results_case30_sigma{sigma}_bias{bias}.csv'))
